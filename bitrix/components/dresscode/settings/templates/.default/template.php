				...
				<div class="switcherContainer">
					...
					<div class="switcherTabs">
						<div class="switcherChangeTabItems">
							...
							<div class="switcherChangeTabItem"><a href="#" class="switcherChangeTab"><?=GetMessage("SETTINGS_CONTACTS_TAB")?></a></div>
							<div class="switcherChangeTabItem"><a href="#" class="switcherChangeTab"><?=GetMessage("SETTINGS_EVENTS_TAB")?></a></div>
						...
						<?include_once($_SERVER["DOCUMENT_ROOT"]."/".$templateFolder."/include/tabs/contacts.php");?>
						<?include_once($_SERVER["DOCUMENT_ROOT"]."/".$templateFolder."/include/tabs/events.php");?>
