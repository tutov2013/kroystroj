<div class="switcherDesignSettings switcherTab">
	...
	<?if(!empty($arResult["TEMPLATES"]["THEMES"]["VARIANTS"])):?>
		...
		<?endif;?>
		<div class="switcherRowBlock">
			<div class="switcherHeading2" title="<?=GetMessage("SETTINGS_NEW_THEME_DESC")?>"><?=GetMessage("SETTINGS_NEW_THEME_DESC")?></div>
			<a href="#" class="switcherCreateCustomTheme"><?=GetMessage("SETTINGS_NEW_THEME_LABEL")?></a>
		</div>
	<?endif;?>
	<div class="switcherRowBlock">
