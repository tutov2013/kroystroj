...
if(isset($arParams["CATALOG_SHOW_TAGS"]) && $arParams["CATALOG_SHOW_TAGS"] == "Y"){
	$arDefaultUrlTemplates404["smart_filter_with_tags"] = $smartBase."tag/#TAG#/filter/#SMART_FILTER_PATH#/apply/";
	$arDefaultUrlTemplates404["tags"] = $smartBase."tag/#TAG#/";
}
...
if($arParams["SEF_MODE"] == "Y")
{
	...
	if ($componentPage === "smart_filter" || $componentPage === "tags" || $componentPage === "smart_filter_with_tags")
...
//push tag to filter path
if(!empty($arResult["VARIABLES"]["TAG"])){
	$arResult["URL_TEMPLATES"]["smart_filter"] = str_replace("/filter/", "/tag/" . $arResult["VARIABLES"]["TAG"] . "/filter/", $arResult["URL_TEMPLATES"]["smart_filter"]);
}
