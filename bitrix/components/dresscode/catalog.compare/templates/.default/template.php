				...
				<td class="left">
					<div class="wrap">
						...
						<div class="headingTools">
							<div class="leftTools">
								<a href="#" class="all sysLinks"><?=GetMessage("ALLFEATURES");?></a>
								<a href="#" class="different sysLinks"><?=GetMessage("DISTINGUISHED");?></a>
								<a href="#" class="btn-simple btn-medium btn-black-border compareClear"><?=GetMessage("CLEAR_COMPARE");?></a>
							</div>
						</div>
						<ul class="propList">
							<?if(!empty($arResult["PROPERTIES"])):?>
