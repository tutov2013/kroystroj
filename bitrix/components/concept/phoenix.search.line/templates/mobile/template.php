...
<form action="<?=$PHOENIX_TEMPLATE_ARRAY["ITEMS"]["SEARCH"]["ITEMS"]["SEARCH_PAGE"]["VALUE"]?>" class = "search-form">

    <div class="search-panel-mob row no-gutters">
        <div class="col-8">
            <div class="search-input-box" id="<?=$arParams["CONTAINER_ID"]?>">
        
                <input id="<?=$arParams["INPUT_ID"]?>" name="q" class="search-style search-js" type="text" value="<?=$query?>" autocomplete="off">
        ...
        <div class="col-4">
            <button class="button-def search-btn-style mob main-color <?=$PHOENIX_TEMPLATE_ARRAY["ITEMS"]["DESIGN"]["ITEMS"]["BTN_VIEW"]['VALUE']?> visible-xs" type="submit">
                <span><?=$PHOENIX_TEMPLATE_ARRAY["MESS"]["SEARCH_BUTTON_NAME"];?></span>
            </button>
        </div>
    </div>
