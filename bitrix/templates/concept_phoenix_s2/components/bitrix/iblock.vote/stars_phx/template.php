...
$arJSParams = array(
	...
	'vote_success' => $PHOENIX_TEMPLATE_ARRAY["MESS"]["RATE_VOTE_SUCCESS_ALERT"]
);

?>

<div class="rating-block rating row no-gutters align-items-center">
	<div class="rating-description"><?=$PHOENIX_TEMPLATE_ARRAY["MESS"]["RATING"]?>: </div>

	<table class="bx_item_detail_rating">
		<tr>
			<td>
				<div class="bx_item_rating">
					<div id="<?=$arJSParams["starsId"]?>" class="bx_stars_container">
	...
	<?/*
		<div class="text-count" id="<?=$arJSParams["ratingId"]?>">(<?=$votesCount?>)</div>
	*/?>
