...
{
    $img = CFile::ResizeImageGet($ar_result["PICTURE"], array('width'=>3000, 'height'=>1500), BX_RESIZE_IMAGE_PROPORTIONAL, false, Array(), false, $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["DESIGN"]["ITEMS"]["PICTURES_QUALITY"]["VALUE"]);  
    $header_back = $img["src"];   
}
					    	...
					    	<div class="<?if($menu_on != "Y"):?>container<?endif;?>">
								...
								<?$section = $APPLICATION->IncludeComponent(
									...
									Array(
										...
										"NEWS_COUNT" => $PHOENIX_TEMPLATE_ARRAY["ITEMS"]["OTHER"]["ITEMS"]["NEWS_COUNT"]["VALUE"],
