...
else
{
	...
	<div class="sale-order-detail">
		...
		?>
		<div class="col-12 sale-order-detail-general">
			<div class="row">
				<div class="col-12 sale-order-detail-general-head">
					<span class="sale-order-detail-general-item bold">
			...
			<div class="row sale-order-detail-about-order">
				...
				<div class="col-12 sale-order-detail-about-order-container">
					<div class="row">
						<div class="col-12 sale-order-detail-about-order-title">
					...
					<div class="row">
						<div class="col-12 sale-order-detail-about-order-inner-container">
							<div class="row">
								<div class="col-md-4 col-6 sale-order-detail-about-order-inner-container-name">
								...
								<div class="col-md-4 col-6 sale-order-detail-about-order-inner-container-status">
								...
								<div class="col-md-<?=($arParams['GUEST_MODE'] !== 'Y') ? 2 : 4?> col-6 sale-order-detail-about-order-inner-container-price">
									<div class="sale-order-detail-about-order-inner-container-price-title">
										<?= Loc::getMessage('SPOD_ORDER_PRICE')?>:
									</div>
									<div class="sale-order-detail-about-order-inner-container-price-detail bold">
										<?= $arResult["PRICE_FORMATED"]?>
									</div>
								</div>
								<?
								...
								{
									?>
									<div class="col-md-2 col-6 sale-order-detail-about-order-inner-container-repeat">
										<a href="<?=$arResult["URL_TO_COPY"]?>" class="main-color sale-order-detail-about-order-inner-container-repeat-button">
							...
							<div class="col-12 sale-order-detail-about-order-inner-container-details">
								...
								if (strlen($arResult["USER_DESCRIPTION"]))
								{
									...
									<div class="col-12 sale-order-detail-about-order-inner-container-list-item-element">
			...
			<div class="row sale-order-detail-payment-options">
				...
				<div class="col-12 sale-order-detail-payment-options-container">
					<div class="row">
						<div class="col-12 sale-order-detail-payment-options-title">
					...
					<div class="row">
						<div class="col-12 sale-order-detail-payment-options-inner-container">
							<div class="row">
								<div class="col-12 sale-order-detail-payment-options-info">
									<div class="row">
										
										<div class="col-12 sale-order-detail-payment-options-info-container">
							...
							<div class="row">
								<div class="col-12 sale-order-detail-payment-options-methods-container">
									<?
									if(!empty($arResult['PAYMENT']))
									{
										...
										{
											?>
											<div class="row no-margin payment-options-methods-row">
												<div class="col-12 sale-order-detail-payment-options-methods">
													<div class="row sale-order-detail-payment-options-methods-information-block">
														<div class="col-lg-2 col-md-3 col-12 sale-order-detail-payment-options-methods-image-container">
														...
														<div class="col-lg-8 col-md-9 col-10 sale-order-detail-payment-options-methods-info">
														...
														{
															?>
															<div class="col-lg-2 col-12 sale-order-detail-payment-options-methods-button-container">
																<?
																if ($payment['PAY_SYSTEM']['PSA_NEW_WINDOW'] === 'Y' && $arResult["IS_ALLOW_PAY"] !== "N")
																{
																	?>
																	<a class="btn-theme main-color sale-order-detail-payment-options-methods-button-element-new-window"
																	   target="_blank"
																...
																else
																{
																	...
																	{
																		?>
																		<a class="btn-theme main-color sale-order-detail-payment-options-methods-button-element inactive-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																		<?
																	}
																	else
																	{
																		?>
																		<a class="btn-theme main-color sale-order-detail-payment-options-methods-button-element active-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																		<?
																	}
																}
																?>
													...
													<div class="col-12 sale-order-detail-payment-options-shipment">
														<div class="row">
															...
															<?
																...
																{
																	?>
																	<div class="col-md-2 col-12 sale-order-detail-payment-options-shipment-button-container">
														...
														<div class="offset-lg-3 col-lg-9 col-12 sale-order-detail-payment-options-shipment-composition-map">
															<?
															...
															if (isset($store))
															{
																?>
																<div class="row">
																	<div class="col-12 sale-order-detail-map-container">
																		<div class="row">
															...
															<div class="row">
																<div class="col-md-12 col-sm-12 sale-order-detail-payment-options-shipment-composition-container">
																	<div class="row">
																		<div class="col-12 sale-order-detail-payment-options-shipment-composition-title">
																								...
																								<?
																									foreach ($shipment['ITEMS'] as $item)
																									{
																										...
																										<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
																											...
																											<div class="sale-order-detail-order-item-nth-4p1"></div>
																											<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
																												<div class="sale-order-detail-order-item-td-title visible-sm visible-xs">
																													<?= Loc::getMessage('SPOD_QUANTITY')?>
																												</div>
			...
			<div class="row sale-order-detail-payment-options-order-content">
				...
				<div class="col-12 sale-order-detail-payment-options-order-content-container">
					<div class="row">
						<div class="col-12 sale-order-detail-payment-options-order-content-title">
											...
											<div class="sale-order-detail-order-item-table">
												...
												foreach ($arResult['BASKET'] as $basketItem)
												{
													...
													<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
														...
														<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
															<div class="sale-order-detail-order-item-td-title visible-sm visible-xs"><?= Loc::getMessage('SPOD_ORDER_PRICE')?></div>
															<div class="sale-order-detail-order-item-td-text">
			...
			<div class="row sale-order-detail-total-payment">
				<div class="col-12 sale-order-detail-total-payment-container">
					<div class="row">
						<ul class="col-md-9 col-7 sale-order-detail-total-payment-list-left">
							<?
						...
						<ul class="col-md-3 col-5 sale-order-detail-total-payment-list-right">
							<?
							if (floatval($arResult["ORDER_WEIGHT"]))
							{
								?>
