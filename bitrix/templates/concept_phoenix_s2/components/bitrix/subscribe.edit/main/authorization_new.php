...
<?if($arResult["ALLOW_ANONYMOUS"]=="Y" && $_REQUEST["authorize"]<>"YES" && $_REQUEST["register"]<>"YES"):?>
	...
	<tr valign="top">
		<td width="40%">
			<p><?echo GetMessage("adm_auth1")?> <a href="<?=SITE_DIR?>auth/?backurl=<?=SITE_DIR;?>personal/subscribe/<?/*echo $arResult["FORM_ACTION"]?>?authorize=YES&amp;sf_EMAIL=<?echo $arResult["REQUEST"]["EMAIL"]?><?echo $arResult["REQUEST"]["RUBRICS_PARAM"]*/?>"><?echo GetMessage("adm_auth2")?></a>.</p>
			<?if($arResult["ALLOW_REGISTER"]=="Y"):?>
				<p><?echo GetMessage("adm_reg1")?> <a href="<?=SITE_DIR?>personal/register/?backurl=<?=SITE_DIR;?>personal/subscribe/<?/*echo $arResult["FORM_ACTION"]?>?register=YES&amp;sf_EMAIL=<?echo $arResult["REQUEST"]["EMAIL"]?><?echo $arResult["REQUEST"]["RUBRICS_PARAM"]*/?>"><?echo GetMessage("adm_reg2")?></a>.</p>
			<?endif;?>
		</td>
	</tr>
	</table>
...
<?elseif($arResult["ALLOW_ANONYMOUS"]=="N" || $_REQUEST["authorize"]=="YES" || $_REQUEST["register"]=="YES"):?>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	<thead><tr><td colspan="2"><h4><?echo GetMessage("adm_auth_exist")?></h4></td></tr></thead>
	<tr valign="top">
		<td width="40%">
	...
	<?if($arResult["ALLOW_REGISTER"]=="Y"):
		...
		<?echo bitrix_sessid_post();?>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
		<thead><tr><td colspan="2"><h4><?echo GetMessage("adm_reg_new")?></h4></td></tr></thead>
		<tr valign="top">
			<td width="40%">
