...
$MESS["SOA_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\" target=\"_blank\">Личном кабинете</a>.";
$MESS["SOA_PAY"] = "Оплата заказа";
$MESS["SOA_PAY_LINK"] = "<a class=\"button-def main-color elips d-block\" href=\"#LINK#\" target=\"_blank\">Оплатить заказ</a>.";
$MESS["SOA_PAY_PDF"] = "Для того, чтобы скачать счет в формате pdf, нажмите на ссылку <a class=\"button-def main-color elips d-block\" href=\"#LINK#\" target=\"_blank\">Скачать счет</a>.";
...
$MESS["SOA_SUM_PAYED"] = "Оплачено с вн. счёта";
...
$MESS["INNER_PS_BALANCE_BEFORE"] = "доступно&nbsp;";
?>
