	...
	BX.Sale.OrderAjaxComponent = {
		...
		getBlockFooter: function(node)
		{
				...
				buttons.push(
					BX.create('button', {
						props: {
							...
							className: 'button-def main-color round-sq pl-3 pr-3'
						},
			...
			if (!isLastNode)
			{
				buttons.push(
					BX.create('button', {
						props: {href: 'javascript:void(0)', className: 'pull-right button-def main-color round-sq pl-3 pr-3'},
		...
		isValidForm: function()
		{
			...
			if (consent.length>0 && !consent.prop("checked")) {
	            ...
	            formAttentionScroll(consent.offset().top - 140, 
					...
					BX.create('DIV', {
						...
						children: [
							BX.create('A', {
								props: {
									href: 'javascript:void(0)',
									className: 'btn-order-save button-def round-sq main-color'
								},
