	...
	<div class="limiter">
		<div class="index-banners-wrap">
			<div class="index-banners">
				...
				<?endif;?>
					<?if(empty($arNextElement["PROPERTIES"]["LINK"]["VALUE"])):?><div<?else:?><a href="<?=$arNextElement["PROPERTIES"]["LINK"]["VALUE"]?>"<?endif;?> class="elem-wrap" id="<?=$this->GetEditAreaId($arNextElement["ID"]);?>">
						<div class="elem">
					...
					<?if(empty($arNextElement["PROPERTIES"]["LINK"]["VALUE"])):?></div><?else:?></a><?endif;?>
